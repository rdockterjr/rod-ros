...
if("TRUE" STREQUAL "TRUE")
  set(beginner_tutorials_SOURCE_PREFIX /home/sonylaptop/github/rod-ros/src/beginner_tutorials)
  set(beginner_tutorials_DEVEL_PREFIX /home/sonylaptop/github/rod-ros/devel)
  ...
  set(beginner_tutorials_INSTALL_PREFIX /home/sonylaptop/github/rod-ros/install)
...
if(NOT "/home/sonylaptop/github/rod-ros/devel/include " STREQUAL " ")
  set(beginner_tutorials_INCLUDE_DIRS "")
  set(_include_dirs "/home/sonylaptop/github/rod-ros/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'beginner_tutorials' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'upboard <rod@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'beginner_tutorials' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/sonylaptop/github/rod-ros/src/beginner_tutorials/${idir}'.  Ask the maintainer 'upboard <rod@todo.todo>' to fix it.")
    endif()
