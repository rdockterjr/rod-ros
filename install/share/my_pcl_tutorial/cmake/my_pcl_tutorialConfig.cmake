...
if("FALSE" STREQUAL "TRUE")
  set(my_pcl_tutorial_SOURCE_PREFIX /home/sonylaptop/github/rod-ros/src/my_pcl_tutorial)
  set(my_pcl_tutorial_DEVEL_PREFIX /home/sonylaptop/github/rod-ros/devel)
  ...
  set(my_pcl_tutorial_INSTALL_PREFIX /home/sonylaptop/github/rod-ros/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'my_pcl_tutorial' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'sonylaptop <sonylaptop@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'my_pcl_tutorial' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/sonylaptop/github/rod-ros/install/${idir}'.  Ask the maintainer 'sonylaptop <sonylaptop@todo.todo>' to fix it.")
    endif()
